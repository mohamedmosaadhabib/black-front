                            ...
                            <div className="col-xl-4 col-lg-4 col-md-6">
                                <div className="card profile_card">
                                    <div className="card-body">
                                        <div className="media">
                                            <img className="mr-3 rounded-circle mr-0 mr-sm-3" src="images/profile/2.png"
                                                 width="60"
                                                 height="60" alt=""/>
                                                <div className="media-body">
                                                    <span>Hello</span>
                                                    <h4 className="mb-2">Maria Pascle</h4>
                                                    <p className="mb-1"><span><i
                                                        className="fa fa-phone mr-2 text-primary"></i></span> +1
                                                        235 5547</p>
                                                    <p className="mb-1"><span><i
                                                        className="fa fa-envelope mr-2 text-primary"></i></span>
                                                        hello@example.com
                                                    </p>
                                                </div>
                                        </div>
                                        ...
                                        <div className="social-icons">
                                            <a className="facebook text-center" href="javascript:void(0)"><span><i
                                                className="fa fa-facebook"></i></span></a>
                                            <a className="twitter text-center" href="javascript:void(0)"><span><i
                                                className="fa fa-twitter"></i></span></a>
                                            <a className="youtube text-center" href="javascript:void(0)"><span><i
                                                className="fa fa-youtube"></i></span></a>
                                            <a className="googlePlus text-center" href="javascript:void(0)"><span><i
                                                className="fa fa-google"></i></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
