...
class VerifyStep2 extends Component {
    style={
                            ...
                            <div className="col-xl-5 col-md-6">
                                <div className="auth-form card">
                                    ...
                                    <div className="card-body">
                                        <form action="https://quixlab.com/demo/elaenia/verify-step-3.html"
                                            ...
                                            <div className="form-group">
                                                ...
                                                <div className="file-upload-wrapper" data-text="front.html">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <span className="float-right">Maximum file size is 2mb</span>
                                                <div className="file-upload-wrapper" data-text="back.html">
                                                    <input name="file-upload-field" type="file"
                                                           className="file-upload-field"
                                                           value=""/>
                                                </div>
                                            ...
                                            <div className="text-center">
                                                <button type="submit" className="btn btn-success pl-5 pr-5">Submit
                                                </button>
                                            </div>
                                        </form>
                                    </div>
